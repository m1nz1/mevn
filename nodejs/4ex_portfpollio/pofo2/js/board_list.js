...
function renderPosts() {
  ...
  if (posts.length === 0) {
    ...
    document.querySelector("td").style.height = "40px";
  } else {
...
function showDetail(index) {
  ...
  document.getElementsByClassName("btn_list")[0].style.cssText =
    "height: 40px; background-color : rgb(154, 212, 183); margin-top:0px; margin-right:0px;";
  document.getElementsByClassName("btn_edit")[0].style.cssText =
    "height: 40px; background-color : rgb(143, 206, 130); margin-top:0px; margin-right:0px;";
  document.getElementsByClassName("btn_del")[0].style.cssText =
    "height: 40px; background-color : rgb(82, 91, 211); margin-top:0px; margin-right:0px;";
  document.getElementsByClassName("btn_pre")[0].style.cssText =
    "height: 40px; background-color : rgb(221, 72, 105); margin-top:0px; margin-right:0px;";
  document.getElementsByClassName("btn_next")[0].style.cssText =
    "height: 40px; background-color : rgb(86, 144, 148); margin-top:0px; margin-right:0px;";
  document
    .getElementsByClassName("btn_list")[0]
    .addEventListener("mouseover", () => {
      document.getElementsByClassName("btn_list")[0].style.cssText =
        "height: 40px; background-color : rgb(108, 172, 140); margin-top:0px; margin-right:0px;";
    });
  document
    .getElementsByClassName("btn_list")[0]
    .addEventListener("mouseleave", () => {
  ...
  document
    ...
    .addEventListener("mouseover", () => {
      document.getElementsByClassName("btn_edit")[0].style.cssText =
        "height: 40px; background-color : rgb(118, 172, 107); margin-top:0px; margin-right:0px;";
    });
  document
    .getElementsByClassName("btn_edit")[0]
    .addEventListener("mouseleave", () => {
  ...
  document
    ...
    .addEventListener("mouseover", () => {
      document.getElementsByClassName("btn_del")[0].style.cssText =
        "height: 40px; background-color : rgb(128, 136, 255); margin-top:0px; margin-right:0px;";
    });
  document
    .getElementsByClassName("btn_del")[0]
    .addEventListener("mouseleave", () => {
  ...
  document
    ...
    .addEventListener("mouseover", () => {
      document.getElementsByClassName("btn_pre")[0].style.cssText =
        "height: 40px; background-color : rgb(245, 104, 134); margin-top:0px; margin-right:0px;";
    });
  document
    .getElementsByClassName("btn_pre")[0]
    .addEventListener("mouseleave", () => {
  ...
  document
    ...
    .addEventListener("mouseover", () => {
      document.getElementsByClassName("btn_next")[0].style.cssText =
        "height: 40px; background-color : rgb(114, 192, 197); margin-top:0px; margin-right:0px;";
    });
  document
    .getElementsByClassName("btn_next")[0]
    .addEventListener("mouseleave", () => {
